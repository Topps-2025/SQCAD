...
>
> - **核心实验报告（外部，逻辑顺序）**：`docs/实验证据链/` —— ① research gap 佐证实验（命题 A/B/C 反例 + 公平性审查）→ ② 形式化定理与陈述（`docs/研究逻辑与理论证明/11-形式化定理陈述与证明.md`）→ ③ 充分识别实验 → ④ 必要性与门控下界 → ⑤ 现实、成本与统计支撑。完整逻辑线见 `docs/研究逻辑与理论证明/00-ResearchGap到充分性与必要性的完整实验逻辑线-20260813.md`。
