...
- `docs/自用/03-实验证据链/09-基线必要性审计与外延声称校准-20260813.md`；
- `docs/自用/03-实验证据链/10-最接近工作全文级核对与因果文献定位-20260813.md`。
...
- `docs/自用/03-实验证据链/01-Gap证明实验报告-v2-20260812.md`；
- `docs/自用/03-实验证据链/02-Gap实验公平性审查-20260812.md`。
...
- `docs/自用/03-实验证据链/03-识别恢复实验报告-20260812.md`；
- `docs/自用/03-实验证据链/04-估计有效性实验报告-20260812.md`。
...
- `docs/自用/03-实验证据链/11-必要性证明实验报告-20260813.md`。
...
- `docs/自用/02-历史草稿/实验报告/外围支撑归档-20260813/05-基线两层比较与统一合同主表-20260812.md`；
- `docs/自用/03-实验证据链/09-基线必要性审计与外延声称校准-20260813.md`；
- `docs/自用/03-实验证据链/10-最接近工作全文级核对与因果文献定位-20260813.md`。
...
- `docs/自用/02-历史草稿/实验报告/外围支撑归档-20260813/06-机制发生率审计与轨迹接地半合成基准-20260812.md`；
- `docs/自用/02-历史草稿/实验报告/外围支撑归档-20260813/07-成本合同与净收益实验报告-20260812.md`；
- `docs/自用/02-历史草稿/实验报告/外围支撑归档-20260813/08-统计与工程门-20260813.md`。
