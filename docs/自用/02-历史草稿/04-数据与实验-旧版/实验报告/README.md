...
>
> - **核心实验报告（当前主入口，逻辑顺序）**：`docs/自用/03-实验证据链/` —— ① research gap 佐证实验（命题 A/B/C 反例 + 公平性审查）→ ② 形式化定理与陈述（`docs/自用/01-research-gap/研究逻辑与理论证明/11-形式化定理陈述与证明.md`）→ ③ 充分识别实验 → ④ 必要性与门控下界 → ⑤ 现实、成本与统计支撑。历史研究路线见 `docs/自用/02-历史草稿/研究路线与方案/00-ResearchGap到充分性与必要性的完整实验逻辑线-20260813.md`。
